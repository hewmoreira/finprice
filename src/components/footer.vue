<template>
  <footer>
    <div id="end">
      ...
      <div class="links">
        <router-link to="/policy" target="_top"> Política de Privacidade </router-link>
      </div>

      <div class="contato">
        <a href="https://github.com/hewmoreira" target="_blank">
          <font-awesome-icon :icon="['fab', 'github']" />
        </a>
        <a href="https://gitlab.com/hewmoreira" target="_blank">
